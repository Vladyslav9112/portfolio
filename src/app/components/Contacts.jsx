...
export default function Contacts() {
  return (
    <section
      className="bg-[#1E1E1E] rounded-2xl p-5 hover:shadow-[0_0_15px_rgba(255,255,255,0.6)] transition duration-200 mb-10 min-h-[200px] flex flex-col justify-center"
      id="contacts"
    >
      <h3 className="text-white text-center mb-10">Contacts:</h3>
      <div className="text-white flex flex-col md:flex-row items-center justify-center gap-6 lg:gap-0">
        {/* Блок з іконками */}
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 lg:gap-15">
          ...
          >
            <Mail
              width={40}
              height={40}
              className="text-white mr-2 object-cover w-[30px] h-[30px] lg:w-9 lg:h-9"
            />
          ...
          >
            <Phone
              width={40}
              height={40}
              className="text-white mr-2 w-[30px] h-[30px] lg:w-9 lg:h-9"
            />
            +38 (068) 27-00-256
          </a>
        </div>
